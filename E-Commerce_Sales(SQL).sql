CREATE TABLE superstore (
    ...
    Sales DECIMAL(10, 2) -- Assuming sales as a decimal value with two decimal places
);
...
*/
SELECT
    AVG(AGE(ship_date, order_date)) AS avg_ship_time
FROM
    superstore;
...
-- Q13) Find the maximum number of days for which total sales on each day kept rising?
